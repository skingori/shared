...
<!-- 111 -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="content">
			...
			$query1="SELECT * FROM employee_table WHERE employee_username='$username'";

			$resource1=mysql_query($query1,$conn);
			echo "<b><u><h4><font color=\"skyblue\">My Profile</font></u></h4></b>
		...
		<tr>
		<td><b>Name</b></td><td><b>Title</b></td> <td><b>Phone Number</b></td><td><b>Employement date</b></td><td><b>Department</b></td></td></tr> ";
			while($result1=mysql_fetch_array($resource1))
			{
				echo "<tr><td>".$result1[1]."&nbsp".$result1[2]."</td><td>".$result1[5]."</td><td>".$result1[7]."</td><td>".$result1[3]."</td><td>".$result1[4]."</td></tr>";
			} echo "</table>";
			?>
