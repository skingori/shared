        	...
        	<div class="col-md-13">
				<div class="panel panel-blue">
					...
					<div class="panel-body">
                        ...
                        mysql_query ("UPDATE messages_table SET message_status = 'READ' WHERE message_id = '$id' ") or die (mysql_error()."failed");
                        $query="SELECT * FROM messages_table WHERE message_id='".$id."'";
