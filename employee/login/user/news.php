        ...
        <div class="col-md-4">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    $query="SELECT * FROM  news_table WHERE `news_date` > timestampadd(day, -1, now());";
        ...
        <div class="col-md-4">
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <?php
                    include("..connection/connector.php");
                    $query="SELECT * FROM  news_table WHERE `news_date` > timestampadd(day, -14, now());";
        ...
        <div class="col-md-4">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <?php
                    include("..connection/connector.php");
                    $query="SELECT * FROM  news_table WHERE `news_date` < date_sub(now(), interval 1 month);";
