...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="content">
        ...
        $query1="SELECT * FROM attendance_table";
		...
		<tr>
		<td><b>Employee Number</b></td><td><b>Attendace Date</b></td> <td><b>Clockin</b></td><td><b>Clockout</b></td></td></tr> ";
        while($result1=mysql_fetch_array($resource1))
        {
            echo "<tr><td>".$result1[1]."</td><td>".$result1[3]."</td><td>".$result1[4]."</td><td>".$result1[5]."</td></tr>";
        } echo "</table>";
        ?>
