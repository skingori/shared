      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              ...
              <li><a href="poproperty.php">View Properties</a></li>
          </ul>
        </li>
          <li class="treeview">
...
<div class="register-box-body">
        ...
        <form id="newapartment" method="POST" action="">
          <div class="form-group has-feedback">
              ...
              <input type="text" autocomplete="off" width="50%" class="form-control" id="" name="username" reaadonly="" placeholder="" value="<?php echo ''.$UserName.'';?>"/>
          ...
          <div class="form-group has-feedback">
            ...
            <input type="text" class="form-control" autocomplete="off" placeholder="" name="bank_name" minlength="3" value="" required/>
            <span class="glyphicon glyphicon-money form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <label> Bank Account No</label>
            <input type="text" class="form-control" autocomplete="off" placeholder="" name="account_num" minlength="3" value="" required/>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
    ...
    <?php
            if (isset($_POST['updatepo'])){
                ...
                if ($mypassword == $repassword)
                    {
                $query="UPDATE users SET username='$Usernamep' , othernames='$OtherNamesp' , sirname='$Sirnamep' ,password='$encrypted' ,bank_name='$bankname' ,bank_account='$accountnum' ,pass_status='secure',logs='Property owner profile edited' WHERE userid='".$userid."'";
              ...
              $log_query=mysql_query("INSERT INTO logs(`activity`,`activity_by` ,`date`)
                        VALUES('user profile updated','By property owner' , now() )
                        ")or die(mysql_error());
              //end of logs
